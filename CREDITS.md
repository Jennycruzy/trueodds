...
- **[Bureau of Labor Statistics public API](https://www.bls.gov/developers/)** and **[BLS time-series flat files](https://download.bls.gov/pub/time.series/cu/)** — official seasonally adjusted core CPI history and all-items CPI-U annual history for the economics engine and backtest. The API is tried first; the official flat-file mirror is used as the quota-free fallback.
